...
fn generate_models(dir: &PathBuf) {
    ...
    let models: Vec<(&str, Box<dyn Sdf>, Vector3<f64>, Vector3<f64>)> = vec![
        // Primitives
        ("01_sphere", Box::new(Sphere::new(Vector3::zeros(), 10.0)),
         Vector3::from_element(-12.0), Vector3::from_element(12.0)),

        ("02_box", Box::new(Box3::new(Vector3::zeros(), Vector3::new(5.0, 3.0, 8.0))),
         Vector3::new(-7.0, -5.0, -10.0), Vector3::new(7.0, 5.0, 10.0)),

        ("03_cylinder", Box::new(Cylinder::new(
            Vector3::zeros(), Vector3::new(0.0, 0.0, 1.0), 5.0, 20.0)),
         Vector3::new(-7.0, -7.0, -2.0), Vector3::new(7.0, 7.0, 22.0)),

        ("04_capped_cone", Box::new(CappedCone::new(
            Vector3::zeros(), Vector3::new(0.0, 0.0, 20.0), 8.0, 2.0)),
         Vector3::new(-10.0, -10.0, -2.0), Vector3::new(10.0, 10.0, 22.0)),

        ("05_torus", Box::new(Torus::new(Vector3::zeros(), 10.0, 3.0)),
         Vector3::new(-15.0, -5.0, -15.0), Vector3::new(15.0, 5.0, 15.0)),

        ("06_rounded_box", Box::new(RoundedBox::new(
            Vector3::zeros(), Vector3::new(5.0, 3.0, 8.0), 1.0)),
         Vector3::new(-8.0, -6.0, -11.0), Vector3::new(8.0, 6.0, 11.0)),

        ("07_capsule", Box::new(Capsule::new(
            Vector3::zeros(), Vector3::new(0.0, 0.0, 20.0), 4.0)),
         Vector3::new(-6.0, -6.0, -6.0), Vector3::new(6.0, 6.0, 26.0)),

        ("08_ellipsoid", Box::new(Ellipsoid::new(
            Vector3::zeros(), Vector3::new(10.0, 5.0, 3.0))),
         Vector3::new(-12.0, -7.0, -5.0), Vector3::new(12.0, 7.0, 5.0)),

        ("09_rounded_cylinder", Box::new(RoundedCylinder::new(
            Vector3::zeros(), 6.0, 1.0, 10.0)),
         Vector3::new(-9.0, -13.0, -9.0), Vector3::new(9.0, 13.0, 9.0)),

        // Boolean operations
        ("10_boolean_union", Box::new(Union::new(
            Sphere::new(Vector3::new(-3.0, 0.0, 0.0), 5.0),
            Sphere::new(Vector3::new(3.0, 0.0, 0.0), 5.0))),
         Vector3::from_element(-10.0), Vector3::from_element(10.0)),

        ("11_boolean_intersection", Box::new(Intersection::new(
            Sphere::new(Vector3::new(-2.0, 0.0, 0.0), 5.0),
            Sphere::new(Vector3::new(2.0, 0.0, 0.0), 5.0))),
         Vector3::from_element(-8.0), Vector3::from_element(8.0)),

        ("12_boolean_difference", Box::new(Difference::new(
            Box3::new(Vector3::zeros(), Vector3::new(10.0, 10.0, 10.0)),
            Sphere::new(Vector3::zeros(), 7.0))),
         Vector3::from_element(-12.0), Vector3::from_element(12.0)),

        // Smooth booleans
        ("13_smooth_union", Box::new(SmoothUnion::new(
            Sphere::new(Vector3::new(-4.0, 0.0, 0.0), 5.0),
            Sphere::new(Vector3::new(4.0, 0.0, 0.0), 5.0), 2.0)),
         Vector3::from_element(-11.0), Vector3::from_element(11.0)),

        ("14_smooth_intersection", Box::new(SmoothIntersection::new(
            Sphere::new(Vector3::new(-2.0, 0.0, 0.0), 6.0),
            Sphere::new(Vector3::new(2.0, 0.0, 0.0), 6.0), 2.0)),
         Vector3::from_element(-8.0), Vector3::from_element(8.0)),

        ("15_smooth_difference", Box::new(SmoothDifference::new(
            Box3::new(Vector3::zeros(), Vector3::new(8.0, 8.0, 8.0)),
            Sphere::new(Vector3::zeros(), 6.0), 1.5)),
         Vector3::from_element(-10.0), Vector3::from_element(10.0)),
        ...
        ("19_mirror", {
            ...
            let combined: Box<dyn Sdf> = Box::new(Union::new(l_bracket, FnSdf::new(move |p| mirrored.evaluate(p))));
            combined
        },
         Vector3::new(-17.0, -2.0, -4.0), Vector3::new(17.0, 12.0, 4.0)),

        ("20_shell", Box::new(Shell::new(
            Sphere::new(Vector3::zeros(), 10.0), 1.0)),
         Vector3::from_element(-13.0), Vector3::from_element(13.0)),
        ...
        ("20b_revolve", {
         ...
         Vector3::new(-13.0, -3.0, -13.0), Vector3::new(13.0, 18.0, 13.0)),
        ...
        ("20c_extrude", {
         ...
         Vector3::new(-10.0, -10.0, -14.0), Vector3::new(10.0, 10.0, 14.0)),

        // Composed shapes
        ("21_mounting_bracket", Box::new(Difference::new(
            Union::new(
                Union::new(
                    Box3::new(Vector3::zeros(), Vector3::new(20.0, 2.0, 15.0)),
                    Capsule::new(
                        Vector3::new(-12.0, 2.0, 0.0),
                        Vector3::new(-12.0, 15.0, 0.0), 3.0)),
                Capsule::new(
                    Vector3::new(12.0, 2.0, 0.0),
                    Vector3::new(12.0, 15.0, 0.0), 3.0)),
            Cylinder::new(
                Vector3::new(0.0, -5.0, 0.0),
                Vector3::new(0.0, 1.0, 0.0), 5.0, 14.0))),
         Vector3::new(-18.0, -4.0, -18.0), Vector3::new(18.0, 18.0, 18.0)),

        ("22_pipe_tee", Box::new(Difference::new(
            SmoothUnion::new(
                Capsule::new(
                    Vector3::new(-15.0, 0.0, 0.0),
                    Vector3::new(15.0, 0.0, 0.0), 5.0),
                Capsule::new(
                    Vector3::new(0.0, 0.0, 0.0),
                    Vector3::new(0.0, 15.0, 0.0), 5.0), 1.5),
            Union::new(
                Capsule::new(
                    Vector3::new(-16.0, 0.0, 0.0),
                    Vector3::new(16.0, 0.0, 0.0), 3.0),
                Capsule::new(
                    Vector3::new(0.0, -1.0, 0.0),
                    Vector3::new(0.0, 16.0, 0.0), 3.0)))),
         Vector3::new(-18.0, -3.0, -8.0), Vector3::new(18.0, 18.0, 8.0)),

        ("23_gasket_ring", Box::new(Intersection::new(
            Torus::new(Vector3::zeros(), 12.0, 4.0),
            Box3::new(Vector3::zeros(), Vector3::new(20.0, 2.0, 20.0)))),
         Vector3::new(-18.0, -4.0, -18.0), Vector3::new(18.0, 4.0, 18.0)),

        ("24_rounded_enclosure", Box::new(Difference::new(
            Difference::new(
                RoundedBox::new(Vector3::zeros(), Vector3::new(15.0, 8.0, 10.0), 2.0),
                Box3::new(Vector3::new(0.0, 1.0, 0.0), Vector3::new(13.0, 7.0, 8.0))),
            Cylinder::new(
                Vector3::new(15.0, 0.0, 0.0),
                Vector3::new(1.0, 0.0, 0.0), 3.0, 10.0))),
         Vector3::new(-19.0, -12.0, -14.0), Vector3::new(19.0, 12.0, 14.0)),

        ("25_organic_blob", Box::new(SmoothUnion::new(
            SmoothUnion::new(
                Sphere::new(Vector3::new(0.0, 0.0, 0.0), 6.0),
                Sphere::new(Vector3::new(5.0, 4.0, 0.0), 4.0), 3.0),
            SmoothUnion::new(
                Sphere::new(Vector3::new(-4.0, 5.0, 3.0), 3.5),
                Sphere::new(Vector3::new(2.0, -3.0, 5.0), 3.0), 3.0), 3.0)),
         Vector3::from_element(-12.0), Vector3::from_element(12.0)),

        ("26_rotated_star", Box::new(Union::new(
            Union::new(
    ...
    for (name, shape, bbox_min, bbox_max) in &models {
        ...
        println!("{} tris, {} verts", mesh.indices.len() / 3, mesh.vertices.len());
    }
...
fn content_type(path: &str) -> &'static str {
    ...
    else if path.ends_with(".obj") { "text/plain" }
    else if path.ends_with(".stl") { "application/octet-stream" }
